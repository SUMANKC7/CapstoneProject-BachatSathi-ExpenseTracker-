...
// import 'package:expensetrack/features/transactions/model/add_party_model.dart';
...
//   Stream<List<AddPartyModel>> listenToEntities() {
//     return _firestore
//         .collection('Entities')
...
//             return AddPartyModel.fromFirestore(doc.data(), doc.id);
//           }).toList();
...
//   Future<List<AddPartyModel>> getCachedEntities() async {
//     try {
...
//           return AddPartyModel.fromFirestore(
...
//   Future<void> _cacheEntitiesLocally(List<AddPartyModel> parties) async {
//     try {
//       final prefs = await SharedPreferences.getInstance();
