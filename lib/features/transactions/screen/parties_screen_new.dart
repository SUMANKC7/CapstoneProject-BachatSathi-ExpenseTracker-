...
//           children: [
//             Text(
//               party.openingBalance == 0 ? 'Rs. 0' : 'Rs. ${party.openingBalance.toStringAsFixed(0)}',
//               style: TextStyle(
//                 fontSize: 16,
//                 fontWeight: FontWeight.bold,
...
//   Widget _buildFilterOption(BuildContext context, String title, bool isSelected, VoidCallback onTap) {
//     return ListTile(
//       title: Text(title),
//       leading: Radio<bool>(
//         value: true,
...
//             if (party.address.isNotEmpty) _buildDetailRow('Address', party.address),
//             _buildDetailRow('Type', party.isCreditInfoSelected ? 'Credit' : 'Debit'),
//           ],
//         ),
//         actions: [
//           TextButton(
...
//       builder: (context) => AlertDialog(
//         title: Text('Delete Party'),
//         content: Text('Are you sure you want to delete ${party.name}? This action cannot be undone.'),
//         actions: [
//           TextButton(
//             onPressed: () => Navigator.pop(context),
//             child: Text('Cancel'),
